...
//! | [Pipe] (Bytewise)<br>(Anonymous or Named)     | [pipe::ReaderNN]<br>[pipe::WriterNN]<br><br>*Not yet stable:*<br>[std::io::PipeReader]<br>[std::io::PipeWriter] | [io::ReadHandle]<br>[io::WriteHandle] |             | IPC
