...
pub mod loader_integrity_continuity {
    pub const MASK          : u64 = 0x00000003u64 << 4;
    pub const DEFER         : u64 = 0x00000000u64 << 4;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 4;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 4;
    pub const AUDIT         : u64 = 0x00000003u64 << 4;
}
...
pub mod strict_control_flow_guard {
    pub const MASK          : u64 = 0x00000003u64 << 8;
    pub const DEFER         : u64 = 0x00000000u64 << 8;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 8;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 8;
    pub const RESERVED      : u64 = 0x00000003u64 << 8;
}
...
pub mod module_tampering_protection {
    pub const MASK          : u64 = 0x00000003u64 << 12;
    pub const DEFER         : u64 = 0x00000000u64 << 12;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 12;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 12;
    pub const NOINHERIT     : u64 = 0x00000003u64 << 12;
}
...
pub mod restrict_indirect_branch_prediction {
    pub const MASK          : u64 = 0x00000003u64 << 16;
    pub const DEFER         : u64 = 0x00000000u64 << 16;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 16;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 16;
    pub const RESERVED      : u64 = 0x00000003u64 << 16;
}
...
pub mod allow_downgrade_dynamic_code_policy {
    pub const MASK          : u64 = 0x00000003u64 << 20;
    pub const DEFER         : u64 = 0x00000000u64 << 20;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 20;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 20;
    pub const RESERVED      : u64 = 0x00000003u64 << 20;
}
...
pub mod speculative_store_bypass_disable {
    pub const MASK          : u64 = 0x00000003u64 << 24;
    pub const DEFER         : u64 = 0x00000000u64 << 24;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 24;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 24;
    pub const RESERVED      : u64 = 0x00000003u64 << 24;
}
...
pub mod cet_user_shadow_stacks {
    pub const MASK          : u64 = 0x00000003u64 << 28;
    pub const DEFER         : u64 = 0x00000000u64 << 28;
    pub const ALWAYS_ON     : u64 = 0x00000001u64 << 28;
    pub const ALWAYS_OFF    : u64 = 0x00000002u64 << 28;
    pub const STRICT_MODE   : u64 = 0x00000003u64 << 28;
}
...
pub mod user_cet_set_context_ip_validation {
    ...
    pub const RELAXED_MODE  : u64 = 0x00000003u64 << 32;
}
...
pub mod block_non_cet_binaries {
    ...
    pub const NON_EHCONT    : u64 = 0x00000003u64 << 36;
}
...
pub mod xtended_control_flow_guard {
    ...
    pub const RESERVED      : u64 = 0x00000003u64 << 40;
}
...
pub mod pointer_auth_user_ip {
    ...
    pub const RESERVED      : u64 = 0x00000003u64 << 44;
}
...
pub mod cet_dynamic_apis_out_of_proc_only {
    ...
    pub const RESERVED      : u64 = 0x00000003u64 << 48;
}
