...
///
pub fn open_thread_token<'a>(thread: impl AsRef<crate::thread::PseudoHandle<'a>>, desired_access: impl Into<crate::token::AccessRights>, open_as_self: bool) -> Result<crate::token::OwnedHandle, crate::Error> {
    use crate::*;
