...
//! | [Console Input Buffer]                        | [io::FileNN]<br>[io::PipeReaderNN]<br>[std::fs::File]                     | [io::ReadHandle]<br>[std::io::Stdin]<br>[std::io::StdinLock]  |                           | IPC
//! | [Console Screen Buffer]                       | [io::FileNN]<br>[io::PipeWriterNN]<br>[std::fs::File]                     | [io::WriteHandle]<br>[std::io::Stdout]<br>[std::io::StdoutLock]<br>[std::io::Stderr]<br>[std::io::StderrLock] | | IPC
...
//! | [Pipe] (Bytewise)<br>(Anonymous or Named)     | [io::PipeReaderNN]<br>[io::PipeWriterNN]<br><br>*Not yet stable:*<br>[std::io::PipeReader]<br>[std::io::PipeWriter] | [io::ReadHandle]<br>[io::WriteHandle] |         | IPC
